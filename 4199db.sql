...
--
-- Host: localhost:3306
-- Generation Time: Feb 17, 2026 at 08:44 PM
...
(1, 'สิริวัฒน์ พุดชา', 'admin1', '$2y$10$TMxe2QR1m2u9/WdDvptxyu5.4es2NVn67O88FdWrxXRasAdvMUFmS'),
(2, 'สิวัฒน์ พุดชา', 'admin2', '$2y$10$9n0Y0wQZyZ6yXf1ZJ9w3rOq5QyqKZ0oH0M4v7k9x2pY3XQJr5oKQ6');
...
--
ALTER TABLE `admin`
  MODIFY `a_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
